using BR.Rodobens.Migration.Api.Service.Configuration;
using MediatR;
...
namespace BR.Rodobens.Migration.Api.Service
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(s =>
            {
                s.SwaggerEndpoint("../swagger/v1/swagger.json", "Migratiin Api - S001");
            });
        }
    }
}
